...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description=(
            "Pick one guide at random from an existing S3-synced articles/index.json and write a teaser feed entry"
        )
    )
    p.add_argument("--articles-index", required=True, help="Path to frontend/app/public/articles/index.json")
